...
import com.cpp.Brcm.models.Professor;
import com.cpp.Brcm.repositories.AddressRepository;
...
public class CustomerController {
	 ...
	 */
	  ...
	  // save a single Customer
	     ...
	     customerRepository.save(new Professor(124, null, "DR Korah", 0,"cs","b8","ML",address));
